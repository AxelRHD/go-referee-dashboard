			...
			h.Div(h.Class("col-md-8"),
				...
				h.Div(h.Class("card mb-4"),
					h.Div(h.Class("card-body"),
						...
						h.P(h.Class("text-muted"),
							g.Text("Einen zuvor exportierten JSON-Dump wiederherstellen."),
						),
						h.FormEl(g.Attr("method", "post"), g.Attr("action", "/setup/restore"),
							...
							h.Div(h.Class("row g-3 align-items-end mb-3"),
								h.Div(h.Class("col"),
									h.Label(h.Class("form-label"), g.Text("JSON-Datei")),
							...
							h.Div(h.Class("mb-3"),
								...
								h.Textarea(h.Class("form-control font-monospace"),
									...
									g.Attr("placeholder", "JSON-Export hier einfügen...")),
							),
				...
				h.Div(h.Class("card mb-4"),
					h.Div(h.Class("card-body"),
						...
						h.P(h.Class("text-muted"),
							g.Text("Ohne Stammdaten starten. Daten können später manuell angelegt oder über die Datenverwaltung importiert werden."),
						),
